...
export async function generateMetadata({
  ...
  icons: {
    ...
    apple: [{ url: "/icon-512.png?v=2", sizes: "512x512", type: "image/png" }],
  ...
  return (
    <html lang={LOCALE_META[lang as Locale].htmlLang}>
      ...
      >
        ...
        {/* Meta-pikselen. Fanger fbclid fra annonseklikket (_fbc-cookie på
            .verkstedpakken.no); CompleteRegistration måles på app.-domenet. */}
