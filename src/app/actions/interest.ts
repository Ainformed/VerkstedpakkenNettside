...
<body style="margin:0;padding:0;background:#f6f1e7;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;color:#0c005a;-webkit-font-smoothing:antialiased;">
    ...
    <tr><td align="center">
      <table role="presentation" width="560" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;width:100%;">
        ...
        <tr><td style="padding:24px 8px 0;font-family:Helvetica,Arial,sans-serif;font-size:12px;color:rgba(12,0,90,0.55);line-height:1.6;">
          ...
          <a href="mailto:x@verkstedpakken.no" style="color:rgba(12,0,90,0.7);text-decoration:none;">x@verkstedpakken.no</a>
          &nbsp;·&nbsp;
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 24px;border-collapse:collapse;">
      <tr><td style="background:#f6f1e7;border-radius:14px;padding:18px 20px;font-family:Helvetica,Arial,sans-serif;">
        ...
        <div style="font-size:15px;color:#0c005a;">
          <a href="mailto:x@verkstedpakken.no" style="color:#0c005a;text-decoration:underline;font-weight:500;">x@verkstedpakken.no</a>
          &nbsp;&nbsp;·&nbsp;&nbsp;
...
export async function submitInterest(
  ...
  try {
    await Promise.all([
      resend.emails.send({
        from: "Verkstedpakken <x@verkstedpakken.no>",
        to: "x@verkstedpakken.no",
        replyTo: email,
